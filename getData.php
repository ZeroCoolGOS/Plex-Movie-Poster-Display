...
// $customTopFont_Name = "$customTopFontID"; // Prototype
// $customBottomFont_Name = "$customTopFontID"; // Prototype

$topStyle = "color: ${topColor}; -webkit-text-stroke: ${topStrokeSize}px ${topStrokeColor};";
if ($topFontEnabled) $topStyle .= " font-family: '$topFontID';"; // Prototype
...
if ($bottomFontEnabled) $bottomStyle .= " font-family: '$bottomFontID';"; // Prototype
